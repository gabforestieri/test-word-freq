package com.wfrequency.service.impl;
...
public class FileServiceImpl implements FileService {
    @Override
    public Map<String, Integer> calculateWordFrequency(BufferedReader reader) throws IOException {
    ...
    private static final Set<String> STOP_WORDS = Set.of(
            ...
            "longer", "m", "made", "make", "making", "man", "many", "may", "me", "member", "members", "men",
            "might", "more", "most", "mostly", "mr", "mrs", "much", "must", "my", "myself", "n", "necessary",
            "need", "needed", "needing", "needs", "never", "new", "newer", "newest", "next", "no", "nobody",
            ...
            "puts", "q", "quite", "r", "rather", "really", "right", "room", "rooms", "s", "said", "same", "saw",
